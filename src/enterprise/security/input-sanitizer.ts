...
// eslint-disable-next-line no-misleading-character-class -- intentional: targets individual zero-width codepoints
...
export function sanitizeInput(raw: string, opts: SanitizeOptions = {}): SanitizeResult {
  ...
  if (stripInvisible) {
    ...
    text = text
      ...
      // eslint-disable-next-line no-control-regex -- intentional: stripping control characters is core sanitizer behavior
