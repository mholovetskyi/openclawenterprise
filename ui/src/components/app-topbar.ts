...
import { enterpriseBrandTitle } from "../lib/enterprise/branding.ts";
          ...
          <div class="topnav-shell__content" @mousedown=${beginNativeWindowDrag}>
            <div class="topbar-brand" aria-label="OpenClaw">
              <img
                ...
                aria-hidden="true"
              />
              <span class="topbar-brand__title">${enterpriseBrandTitle()}</span>
              <span class="topbar-brand__enterprise-badge">Enterprise</span>
              ${this.environment &&
