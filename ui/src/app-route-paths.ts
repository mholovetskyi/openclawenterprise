...
const APP_ROUTE_DEFINITIONS = {
  ...
  // Enterprise fork: admin panel (IAM, audit, security, cluster). The
  // /enterprise alias keeps pre-restructure bookmarks working.
  enterprise: { path: "/settings/enterprise", aliases: ["/enterprise"] },
