...
const SETTINGS_NAVIGATION_GROUPS = [
  ...
  // Enterprise fork: admin panel (IAM users & roles, audit log, security,
  // cluster). Admin-only — deliberately absent from the non-admin groups.
  {
    labelKey: "nav.settingsGroupEnterprise",
    routes: ["enterprise"],
  },
  {
